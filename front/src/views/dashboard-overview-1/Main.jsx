        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-6 mt-8">
            <div className="intro-y box p-5 mt-5">
              <h1>Active Users</h1>
              <div className="mt-3">
                <ReportPieChart height={213} data={[insights.activeUser.count, insights.allUsersCount - insights.activeUser.count]}/>
              </div>
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-6 mt-8">
            <div className="intro-y box p-5 mt-5">
              ...
              <div className="mt-3">
                <ReportPieChart height={213} data={[insights.verifiedUsers.count, insights.allUsersCount - insights.verifiedUsers.count]}/>
              </div>
              <div className="w-52 sm:w-auto mx-auto mt-8">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-success rounded-full mr-3"></div>
